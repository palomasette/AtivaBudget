...
layout = dbc.Card([
    ...
    # Seção PERFIL ------------------------
                dbc.Button(id='botao_avatar',
                           children=[html.Img(src="/assets/photo_paloma.png", id="avatar_change", alt="Avatar", className='perfil_avatar'),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardImg(src="/assets/user_man.png", className='perfil_avatar', top=True),
                                    dbc.CardBody([
                            ...
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardImg(src="/assets/user_woman.png", top=True, className='perfil_avatar'),
                                    dbc.CardBody([
...
def salve_form_receita(n, descricao, valor, date, switches, categoria, dict_receitas):
    ...
    if n and not(valor == "" or valor== None):
        ...
        #categoria = categoria[0] if isinstance(categoria, list) else None
...
def salve_form_despesa(n, valor, switches, categoria, date, descricao, dict_despesas):
    ...
    if n and valor is not None and valor != "":
        valor = round(float(valor), 2)
        date = pd.to_datetime(date).date()
        ...
        df_despesas.loc[df_despesas.shape[0]] = [
            valor, recebido, fixo, date, descricao, categoria]
